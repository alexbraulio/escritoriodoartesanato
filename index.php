	                ...
	                <div class="row">
	                    <div class="col-md-12 text-center">
	                        <div class="home_text wow fadeInUp animated">
	                            <h2>Facilidade para atersnato.</h2>
	                            <p>Espaço para divulgação e venda de artigos para artesanato, e peças feitas manualmente.</p>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="copyright_text   wow fadeInUp animated">
                        <p>&copy; Escritório do Artesanato 2015.All Right Reserved By <a href="#"target="_blank">Code Cafe Team</a></p>
